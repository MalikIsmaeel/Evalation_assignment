import { watch, effectScope, reactive, computed, version, unref, inject, defineComponent, h, getCurrentInstance, onUnmounted, provide, shallowReactive, ref, Suspense, nextTick, Transition, hasInjectionContext, Fragment, useSSRContext, createApp, shallowRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isReadonly, Text, isRef, isShallow, isReactive, toRaw, mergeProps } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/create-UbAQgBS-.mjs').then((m) => m.default || m)
  },
  {
    name: "create___es",
    path: "/es/create",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8-PNCZE8.mjs').then((m) => m.default || m)
  },
  {
    name: "index___es",
    path: "/es",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Layout-rS0nTeJz.mjs').then((m) => m.default || m)
  },
  {
    name: "Layout___es",
    path: "/es/Layout",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-maW-P3kQ.mjs').then((m) => m.default || m)
  },
  {
    name: "post-id___es",
    path: "/es/post/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/testing-wNZul6oP.mjs').then((m) => m.default || m)
  },
  {
    name: "testing___es",
    path: "/es/testing",
...
const localeMessages = {
  "en": [{ key: "../lang/en-US.json", load: () => import(
    './_nuxt/en-Us-4DDbpo3z.mjs'
    /* webpackChunkName: "locale_C_58_C_58_Users_user_Documents_GitHub_nuxt_app_lang_en_US_json" */
  ), cache: true }],
  "es": [{ key: "../lang/en-US.json", load: () => import(
    './_nuxt/en-Us-4DDbpo3z.mjs'
    /* webpackChunkName: "locale_C_58_C_58_Users_user_Documents_GitHub_nuxt_app_lang_en_US_json" */
  ), cache: true }],
  "ar": [{ key: "../lang/ar-SA.json", load: () => import(
    './_nuxt/ar-SA-ViARi-DV.mjs'
    /* webpackChunkName: "locale_C_58_C_58_Users_user_Documents_GitHub_nuxt_app_lang_ar_SA_json" */
  ), cache: true }]
};
...
const store = createStore({
  ...
  actions: {
    async addPosts({ commit }, postData) {
      const post = axios.post(`https://mustf.wmc-ksa.com/api/posts`, postData).then((response) => {
    ...
    async getPost({ commit }) {
      const post = axios.get(`https://mustf.wmc-ksa.com/api/posts`).then((response) => {
        commit("addPost", response.data);
        return post;
      }).catch((err) => {
      });
    ...
    async onePosts({ commit }, dataPost) {
      const post = axios.get(`https://mustf.wmc-ksa.com/api/posts/${dataPost}`).then((response) => {
...
const _sfc_main$2 = {
  ...
  mounted() {
    console.log((void 0).body.dir);
  }
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtPage = __nuxt_component_1;
  _push(ssrRenderComponent(_component_NuxtPage, mergeProps({ class: "" }, _attrs), null, _parent));
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-p-h1cEwe.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-2W2YMXLq.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-XpLssvHY.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, mapGetters as a, mapActions as b, __nuxt_component_1 as c, parseQuery$1 as d, useRuntimeConfig as e, navigateTo as f, withoutTrailingSlash$1 as g, hasProtocol as h, injectHead as i, joinURL as j, createError as k, mapState as m, nuxtLinkDefaults as n, parseURL as p, resolveUnrefHeadInput as r, server as s, useRouter as u, withTrailingSlash$1 as w };
